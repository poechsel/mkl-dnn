...
if(WIN32)
    ...
    elseif(EXISTS ${TBB_ROOT}/src/tbb/tbb_version.h)
        option(TBB_STATIC_LIB "Build TBB as a static library (building TBB as a static library is NOT recommended)")
        set(OIDN_TBB_STATIC_LIB_ROOT "" CACHE STRING "Path to the root of the statically build tbb")
        if(TBB_STATIC_LIB)
            set(TBB_INCLUDE_DIR ${TBB_ROOT}/include)
            SET(TBB_LIBRARY ${OIDN_TBB_STATIC_LIB_ROOT}/libtbb_static.a)
            SET(TBB_LIBRARY_MALLOC ${OIDN_TBB_STATIC_LIB_ROOT}/libtbbmalloc_static.a)
        else()
